...
public class RestClientConfig {
    ...
    public CloseableHttpClient getHttpClient() throws Exception {
        ...
        connManager.setSocketConfig(route.getTargetHost(),SocketConfig.cusraluca().setSoTimeout(25000).setSoLinger(20).build());        

        RequestConfig config = RequestConfig.cusraluca().build();
