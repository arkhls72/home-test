...
public class ProxyApiException extends RuntimeException {
     ...
     */
    public ProxyApiException(final String message, final Throwable cause,
     ...
     */
    public ProxyApiException(final Throwable cause, final Object... parameters) {
     ...
     * @param parameters optional parameters to message
     */
    public ProxyApiException(final String message, final Object... parameters) {
