...
/**
 *  Implementation of Remote QueueRelayRemote. This remote is for test purpose only. 
 *  It sends mock text to internal jms/EarnTransactionQueue
...
@Stateless
public class QueueRelayBean implements QueueRelayRemote,Serializable{
	private static final long serialVersionUID = -8638502826387997464L;

	private static Logger logger = LoggerFactory.getLogger(QueueRelayBean.class);
	...
	public String sendTextMessagetoQueue() throws Exception {
	        ...
	        try {
	            ...
	            Queue theQueue = (Queue) ic.lookup(jndiPath + EjbProperty.getProperty(Property.INTERNAL_EARN_PUBLISH_QUEUE));
