...
//for test please use relay-rest module . localhost:8080/rest/send
public class TestRemoteEjb {
	private Logger logger = LoggerFactory.getLogger(TestRemoteEjb.class);
	private static final String JNDI_PATH = "ejb:jboss/exported/relay-ejb/relay-ejb-0.0.1-SNAPSHOT/"; 
	...
	public void sendMessageToQueeu() throws Exception  {
    	QueueRelayRemote remote =  (QueueRelayRemote)  ctx.lookup(JNDI_PATH + QueueRelayRemote.JNDI);
