...
/**
 * 
 * A simple get REST service call to test remote EJB  QueuereplyRemote
...
public class RestService extends AbstractService{
	...
	private final static String _jndi_prefix = "java:jboss/exported/reply-ejb/reply-ejb/";
    ...
    public String sendMessageToQueue(HttpServletResponse response) throws Exception {
		...
		try {
			...
			QueuereplyRemote queuereplyRemote = (QueuereplyRemote) this.getInitialContext().lookup(_jndi_prefix + QueuereplyRemote.JNDI);
			ejbResponse = queuereplyRemote.sendTextMessagetoQueue();
